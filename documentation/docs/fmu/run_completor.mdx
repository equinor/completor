...
This is a step by step on calling running Completor® as part of ERT workflow.
...
Pay attention to the output after pre-processor job on where is the output file since it will feed Completor as input file.
