...
This keyword is widely used on other types of devices in Completor for example `ICV` and `RCP`.
```
COMPLETION
--Well  Branch  StartMD  EndMD  Screen    Well/   Roughness  Annulus  Nvalve  ValveType  DeviceNumber
--      Number                  Tubing    Casing             Content  /Joint
...
## Completion with RCP
An example with RCP (Rate Controlled Production).
...
--      Number                      Tubing    Casing                    Content
--                                  Diameter   Diameter
OP1     1        0        10000     0.15364    0.1905    1.524E-005      GP          1                RCP         1
OP1     2        0        10000     0.15364    0.1905    1.524E-005      GP          1                RCP         2
/
