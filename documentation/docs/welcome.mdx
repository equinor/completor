...
Completor® covers also the functionality to actively control Inflow Control Valve (ICV) the wells with [ICV Control](./icvc/icvc.mdx).
...
and some [examples](./about/examples.mdx). Separate sections are dedicated also on example to extend the use of Completor with ICV Control [examples](./icvc/examples.mdx).
