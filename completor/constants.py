...
class ICVMethod(Enum):
    ...
    OPEN_PYACTION = "OPEN_PYACTION"
    OPEN_WAIT_PYACTION = "OPEN_WAIT_PYACTION"
    OPEN_READY_PYACTION = "OPEN_READY_PYACTION"
    OPEN_STOP_PYACTION = "OPEN_STOP_PYACTION"
    OPEN_WAIT_STOP_PYACTION = "OPEN_WAIT_STOP_PYACTION"

    CHOKE_PYACTION = "CHOKE_PYACTION"
    CHOKE_READY_PYACTION = "CHOKE_READY_PYACTION"
    CHOKE_WAIT_PYACTION = "CHOKE_WAIT_PYACTION"
    CHOKE_STOP_PYACTION = "CHOKE_STOP_PYACTION"
    CHOKE_WAIT_STOP_PYACTION = "CHOKE_WAIT_STOP_PYACTION"
