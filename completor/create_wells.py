...
class CreateWells:
    ...
    def update(self, well_name: str, schedule: wells2.WellSchedule) -> None:
        ...
        for lateral in active_laterals:
            ...
            self.df_welsegs_header, self.df_welsegs_content = wells2.get_well_segments(
...
def _select_well(well_name: str, schedule: wells2.WellSchedule, lateral: int) -> pd.DataFrame:
    ...
    """
    df_compsegs = wells2.get_completion_segments(schedule.msws, well_name, lateral)
    df_compdat = wells2.get_completion_data(schedule.msws, well_name)
