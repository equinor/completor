...
def test_read_case_wsegdensity():
    ...
    df_true = pd.DataFrame(
        [
            [Content.DENSITY_BASED, 1, 0.1, 0.4, 0.3, 0.2, 0.6, 0.70, 0.8, 0.9],
            [Content.DENSITY_BASED, 2, 0.1, 0.4, 0.3, 0.2, 0.5, 0.60, 0.7, 0.8],
        ],
        columns=[
            Headers.DEVICE_TYPE,
            Headers.DEVICE_NUMBER,
...
def test_new_density_old_parameters():
    ...
    expected_err = f"Too few entries in data for keyword '{Content.DENSITY_BASED}', expected 9"
